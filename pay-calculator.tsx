...
const salaries = [
  ...
  { role: "Account Executive", seniority: "Junior", salary: "64291.04" },
  { role: "Account Executive", seniority: "Intermediate", salary: "85721.39" },
  { role: "Account Executive", seniority: "Senior", salary: "107151.74" },
...
export default function PayCalculator() {
  ...
  const calculate = () => {
    ...
    if (salaryEntry) {
      ...
      setSalaryUSDMin(Math.trunc(salaryInEURMin * 1.16657).toLocaleString())
      setSalaryUSDMax(Math.trunc(salaryInEURMax * 1.16657).toLocaleString())
    }
  }
